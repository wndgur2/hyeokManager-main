...
export default function ActiveMemo({memo, tempMemo, setTempMemo, memos, finishAdding}){
  return (
    <View style={{paddingHorizontal:10, margin:10, width:"100%", backgroundColor:blacks[49]}}>
      <TextInput
        style={{fontSize:20, margin:2, padding:8, width:"100%", letterSpacing:1, lineHeight:36}}
        multiline={true}
